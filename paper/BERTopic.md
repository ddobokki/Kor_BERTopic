...
4. BERTopic에서는 c-TF-IDF를 활용하여 동적 토픽 모델링을 할 수 있음
    ...
    5. 그 다음 각 topic(global)의 local representation을 만들 수 있다. 사전에 계산된 c-IDF에 타임 스텝별 tf 값을 곱함으로 구할 수 있다.<img src = "https://latex.codecogs.com/gif.latex?W_t,_c_i=tf_t,_c_i\cdot\log(1+\frac{A}{tf_t})">
